...
from courses.views import home,course_create,course_update,course_delete, lesson_create, lesson_delete, lesson_update,enroll_student,view_students,course_detail,mark_lesson_complete
urlpatterns = [
